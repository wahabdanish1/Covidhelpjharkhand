<%@ Page Title="" Language="C#" MasterPageFile="~/CovidHelp.Master" AutoEventWireup="true" CodeBehind="Ranchi.aspx.cs" Inherits="Covidhelp.Ranchi" %>
                  ...
                  <div class="tab-content text-center">
                                <div class="tab-pane active" id="GvHospital_Area">
                                    <div class="table-responsive">
                                        ...
                                        <div class="space-50">
                                        <asp:Label ID="lblNoHospital" Text="" runat="server" ForeColor="Red"  />
                                        </div>
                                    </div>
                                </div>

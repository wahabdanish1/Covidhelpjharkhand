<%@ Page Title="" Language="C#" MasterPageFile="~/CovidHelp.Master" AutoEventWireup="true" CodeBehind="palamu.aspx.cs" Inherits="Covidhelp.palamu" %>
                                        ...
                                        <asp:GridView ID="GvHospital" runat="server" AutoGenerateColumns="false" class="table">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Hospital Phone" HeaderStyle-CssClass="text-center">
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label1" runat="server" Text='<%#Eval("Hospital_Phone_no")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="Incident Commander" HeaderStyle-CssClass="text-center">
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label2" runat="server" Text='<%#Eval("Incident_Commander_No")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="Total Bed" HeaderStyle-CssClass="text-center">
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label3" runat="server" Text='<%#Eval("Total_Bed")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="Available Bed" HeaderStyle-CssClass="text-center">
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label4" runat="server" Text='<%#Eval("Available_Bed")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="ICU Bed" HeaderStyle-CssClass="text-center">
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label5" runat="server" Text='<%#Eval("ICU_Bed")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="Oxygen Bed" HeaderStyle-CssClass="text-center">
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label6" runat="server" Text='<%#Eval("Oxy_Bed")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="Normal Bed" HeaderStyle-CssClass="text-center">
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label7" runat="server" Text='<%#Eval("Normal_Bed")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="Updated Date" HeaderStyle-CssClass="text-center">
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label8" runat="server" Text='<%#Eval("Updated_Date")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        ...
                                        <asp:GridView ID="GvOxygen" runat="server" AutoGenerateColumns="false" class="table">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Organization Name" HeaderStyle-CssClass="text-center">
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label9" runat="server" Text='<%#Eval("Organization_Name")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="Contact Person" HeaderStyle-CssClass="text-center">
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label10" runat="server" Text='<%#Eval("Contact_Person")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="Phone_no" HeaderStyle-CssClass="text-center">
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label11" runat="server" Text='<%#Eval("Phone_no")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="Updated Dated" HeaderStyle-CssClass="text-center">
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label12" runat="server" Text='<%#Eval("Updated_Dated")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        ...
                                        <asp:GridView ID="GvPlazma" runat="server" AutoGenerateColumns="false" class="table">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Blood Group" HeaderStyle-CssClass="text-center">
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label13" runat="server" Text='<%#Eval("Blood_group")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="Donor Name" HeaderStyle-CssClass="text-center">
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label13" runat="server" Text='<%#Eval("Contact_Person")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="Phone_no" HeaderStyle-CssClass="text-center">
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label14" runat="server" Text='<%#Eval("Phone_no")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="Updated Dated" HeaderStyle-CssClass="text-center">
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label16" runat="server" Text='<%#Eval("Updated_Date")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView ID="GvDoctor" runat="server" AutoGenerateColumns="false" class="table">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Hospital Name" HeaderStyle-CssClass="text-center">
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label17" runat="server" Text='<%#Eval("Hospital_Name")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="Doctor Name" HeaderStyle-CssClass="text-center">
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label18" runat="server" Text='<%#Eval("Doctor_Name")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="Phone no" HeaderStyle-CssClass="text-center">
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label19" runat="server" Text='<%#Eval("Phone_no")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="Updated Dated" HeaderStyle-CssClass="text-center">
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label20" runat="server" Text='<%#Eval("Updated_Date")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView ID="GvAmbulance" runat="server" AutoGenerateColumns="false" class="table">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Hospital Name" HeaderStyle-CssClass="text-center">
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label21" runat="server" Text='<%#Eval("Hospital_Name")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="Contact Person" HeaderStyle-CssClass="text-center">
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label22" runat="server" Text='<%#Eval("Contact_Person")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="Phone_no" HeaderStyle-CssClass="text-center">
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label23" runat="server" Text='<%#Eval("Phone_no")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="Updated Dated" HeaderStyle-CssClass="text-center">
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label24" runat="server" Text='<%#Eval("Updated_Date")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView ID="GvFood" runat="server" AutoGenerateColumns="false" class="table">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Organization Name" HeaderStyle-CssClass="text-center">
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label25" runat="server" Text='<%#Eval("Organization_Name")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="Contact Person" HeaderStyle-CssClass="text-center">
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label26" runat="server" Text='<%#Eval("Contact_Person")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="Phone_no" HeaderStyle-CssClass="text-center">
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label27" runat="server" Text='<%#Eval("Phone_no")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="Updated Dated" HeaderStyle-CssClass="text-center">
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label28" runat="server" Text='<%#Eval("Updated_Date")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
